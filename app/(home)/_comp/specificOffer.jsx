...
const offers = [
    ...
    },
    {
        ...
        offerDesc:
            "Surgical interventions for conditions of the colon and rectum.",
        whatsapp: "+66948382910",
    },
    {
    ...
    },
    {
        ...
        offerName: "Urology",
        offerDesc:
            "Care for urinary tract and male reproductive system disorders.",
        whatsapp: "+66948382910",
    },
];
                        ...
                        <SwiperSlide key={index} className='p-4'>
                            <div className='flex flex-col items-center justify-between shadow-xl rounded p-4 min-h-[300px]'>
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        handleWhatsAppClick(offer.whatsapp)
                                    }
                                >
