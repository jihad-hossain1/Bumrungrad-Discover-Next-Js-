...
//       email,
//       prescriptionImg,
//       medicineArrys:  JSON.stringify(medicArr)
//     }
...
//    try {
//      setLoader(true)
//    const response = await  fetch('https://api.discoverinternationalmedicalservice.com/api/add/order/medicine', {
//        method: 'POST',
//        body: formData,
//      })
//      setLoader(false)
...
//      if(jsonData.status === 200) {
//        toast.success("Medicine Order Placed! Our support team will contact you soon.")
      
//        setLoader(true);
//        const admin_mail_response = await sendEmails(admin_mails,`Order Medicine Request from ${name}`, mailBody(formDatas));
//        setLoader(false);

//        setLoader(true);
//        const user_mail_response = await sendEmails(userDetails?.email,`Order Medicine Request from ${name}`, mailBody(formDatas));
//        setLoader(false);

//       if(admin_mail_response.messageId && user_mail_response.messageId) {
//         toast.success("Medicine Order Placed! Our support team will contact you soon.")
//         navigate.push('/')
//       }else{
//         toast.error("Something went wrong, Sending Mail")
//       }
...
//           }`}
//           onClick={orderMedicine}
//           disabled={medicArr.length === 0 && prescriptionImg === '' || loader}
//         >
//           Submit
//           {loader && (
//             <div className='flex gap-0.5'>
