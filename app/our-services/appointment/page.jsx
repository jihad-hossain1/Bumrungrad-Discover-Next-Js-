                                ...
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <FormControl fullWidth>
                                        ...
                                        <Select
                                            ...
                                            onChange={(e) =>
                                                setSubSpeacility(e.target.value)
                                            }
                                            disabled={
                        ...
                        {stepperOpen2 && (
                            <div className=' flex flex-col justify-center items-center gap-5 '>
                                ...
                                <p className='font-semibold text-center mt-5 md:text-xl text-blue'>
                                    This is only a tentative booking. Your
                                    actual appointment will be confirmed by
                                    email.
                                </p>
                                    ...
                                    {!activeYourSelf && (
                                        <h1 className='text-red font-semibold my-2.5'>
                                            * Please update the following fields
                                            with required patient information
                                        </h1>
                                    )}
                                    <Divider />
